...
public class BookDao {
    /*
    Book SQL sorgularını yönettiğimiz metot;
     */
    ...
    public ArrayList<Book> findAll(){
        return this.selectByQuery("SELECT * FROM public.book");
    }
    ...
    public boolean save(Book book){
        ...
        try {
            ...
            pr.setDate(6, Date.valueOf(book.getStart_date()));
            pr.setDate(7,Date.valueOf(book.getFinish_date()));
    ...
    public Book match(ResultSet rs) throws SQLException {
        ...
        book.setStart_date(LocalDate.parse(rs.getString("book_strt_date")));
        book.setFinish_date(LocalDate.parse(rs.getString("book_fnsh_date")));
