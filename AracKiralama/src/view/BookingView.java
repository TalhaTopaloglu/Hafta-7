...
public class BookingView extends Layout{
    ...
    // Booking View'da oluşturduğumuz pencerenin işlemlerini yönetildiği sınıf.
    public BookingView(Car selectedCar, String strt_date, String fnsh_date){
        ...
        this.fld_book_mpno.setText("05509870550");
        ...
        btn_book_save.addActionListener(e -> {
            ...
            if(Helper.isFieldListEmpty(checkFieldList)){
                ...
                book.setStart_date(LocalDate.parse(strt_date, DateTimeFormatter.ofPattern("dd/MM/yyyy")));
                book.setFinish_date(LocalDate.parse(fnsh_date, DateTimeFormatter.ofPattern("dd/MM/yyyy")));
